...
const API_BASE_URL = `https://appnor-backend.onrender.com/extras/v1/api/parsing/semantic-parser?siteUrl=`;
...
function HomePage(props: any) {
  ...
  return (
    ...
    >
      {backdrop}
      <FeatureIntro
        heading="Power Web with Our HTML Scraping Ninja!"
        desc="Trapped in the confines of ordinary web browsing?  Slice through the limitations and extract pure HTML gold from any website with our lightning-fast scraping tool!⚡️Simply provide a URL, and watch as our ninja swiftly captures every element, structure, and data point, delivering them to your command! Uncover hidden insights, conduct effortless research, build custom datasets, and automate tasks like a true webmaster!"
      />
